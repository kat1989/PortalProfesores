...
if(bgco)
{
	...
	{
		document.getElementById("gcItem"+id).style.backgroundColor="#e01a22";
		document.getElementById("gcItem"+id).style.color= "#3a0a0b";
		document.getElementById("gcExpand"+id).style.backgroundColor="#ffffff";
	}
	if(document.getElementById("gcExpandIc"+id))
	{
		document.getElementById("gcExpandIc"+id).src=gcExdIS.src;
...
function gcButtonSunken(id)
{
	...
	obj.color = "#ffffff";
	}function gcButtonNormal(id){var obj = document.getElementById(id).style;obj.borderTopColor = "";obj.borderLeftColor = "";obj.borderBottomColor = "";obj.borderRightColor = "";obj.backgroundColor = "";obj.paddingBottom = "4px";obj.paddingTop = "4px";obj.paddingLeft = "6px";obj.paddingRight = "6px";obj.color = "#ffffff";}function gcMenuBarInit(){}
//-->
